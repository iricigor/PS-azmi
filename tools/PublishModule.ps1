...
Get-Item $publishDir | Select LastWriteTime, CreationTime, Name
Get-ChildItem $publishDir | Select LastWriteTime, CreationTime, Name | Sort-Object CreationTime -Descending
